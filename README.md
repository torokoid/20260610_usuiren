...
width:100%;
height:100vh;
background:url(https://torokoid.github.io/20260610_usuiren/20260610_006.png) center/cover no-repeat;
...
<!--QRコードの挿入例-->
<p align="left"> <img src="QR_2026Jun10_.png" alt="アクセス用QRコード" width="100">QR for Access</p>
<p align="right"><marquee direction="left" scrollamount="20" width="30%">(^_^)/~S.Hada</marquee></p>

<!--流れ文字の挿入例-->
<h1><span class="yellow"><marquee behavior="left">!!! 2026/06/10、宇都宮市水泳連盟HPの構成概要 !!!</marquee></span></h1>
...
<h2><span class="yellow">サイトのアカウントとパスワードでアクセスした画面<br>ファイル管理ボタンを押して編集画面に移動します</span></h2>
<a href="20260610_001.png" target="_blank"><img src="20260610_001.png" alt="サンプル画像" class="responsive-media"></a>

<h2><span class="yellow">public_html内のschedule.htmlが予定表のあるページのデータです</span></h2>
<a href="20260610_002.png" target="_blank"><img src="20260610_002.png" alt="サンプル画像" class="responsive-media"></a>

<h2><span class="yellow">編集窓が開いてhtmlのコードを編集出来るようになります</span></h2>
<a href="20260610_003.png" target="_blank"><img src="20260610_003.png" alt="サンプル画像" class="responsive-media"></a>
...
<h2><span class="yellow">編集窓は小さいので通常はhtmlファイルをPCにダウンロードしてPC内で編集、完成品を後でアップロードするのが楽です</span></h2>
<a href="20260610_005.png" target="_blank"><img src="20260610_005.png" alt="サンプル画像" class="responsive-media"></a>
<h2><span class="yellow">画面はhtml編集用のエディターBracketsの画面、上から下までの間が予定表部分のhtmlコードです<br>Bracketsは宇都宮市水泳連盟メンバーでは大森くんが使っています</span></h2>
...
<br><br><br>
<h2><span class="yellow">以上、HP編集するにはhtmlの知識が必要になりますが、今回は宇都宮市水泳連盟HPの構成概要の紹介でした<br>Thank you for reading this far.</span></h2>
<!--
<br><br><br><br><br>
...
<!-- フッタ -->
<footer>
<p>Copyright 2026/06/10 S.Hada</p>
</footer>
